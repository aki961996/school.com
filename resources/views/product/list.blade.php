...
<div class="container">
    <div class="row">
        <div class="col-12 text-center pt-5">
            <h5 class="display-one m-5">This section tells the TODO to prepare the development to run a PHP Laravel app.
            </h5>
            <div class="text-right"><a href="{{route('product-create')}}" class="btn btn-outline-primary">Add new
                    product</a></div>
