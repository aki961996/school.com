    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center pt-5">
                <h1 class="display-one mt-5">Add</h1>
                <div class="text-left"><a href="{{route('product-list')}}" class="btn btn-outline-primary">Product
                        List</a>
                </div>

                <form id="add-frm" method="POST" action="{{route('product-store')}}" class="border p-3 mt-2">
